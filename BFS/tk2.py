...
class NetworkCrawlerGUI:
    ...
    def generate_graph(self):
        ...
        # Rest of the graph layout code remains the same
    ...
    def draw_graph(self):
        ...
        # Draw edges with color based on traversal
        edges = self.G.edges()
        edge_colors = []
        for edge in edges:
        ...
        nx.draw_networkx_edges(self.G, self.pos, ax=self.ax,
                               ...
                               width=[2 if c == 'gray' else 3 for c in edge_colors])
        ...
        for node in self.G.nodes():
            if node == self.current_node:
                ...
                color = 'yellow'  # Yellow for queued nodes
            else:
    ...
    def next_step(self):
        ...
        previous_current = self.current_node
        self.current_node = node

        # Add all unvisited neighbors to queue (similar to JavaScript bfsStep)
